...
//		points[2]=data[2]-'0';    //调试换算
		...
		{
			if(data[0]=='w') destination[1][Step_Count]=points[2]-30;
			else             destination[1][Step_Count]=points[2];
		}
		else if(enter_direction==RIGHT)
		{
			if(data[0]=='w') destination[1][Step_Count]=400-points[2]-30;
...
//		points[5]=data[2]-'0';    //调试换算
		...
		{
			if(data[0]=='w') destination[1][Step_Count]=400-points[5]-30;
			else             destination[1][Step_Count]=400-points[5];
		}
		else
		{
			if(data[0]=='w') destination[1][Step_Count]=points[5]-30;
